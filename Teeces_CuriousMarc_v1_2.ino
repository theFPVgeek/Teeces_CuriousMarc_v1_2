...
const int cZ[] PROGMEM = { B00001111,
             ...
             B00000001,
             B00001111 };
const int c0[] PROGMEM = { B00000110,
             B00001101,
             B00001011,
             B00001011,
             B00000110 };
//Non-letters
const int c1[] PROGMEM = { B00000110,
             B00000101,
             B00000100,
             B00000100,
             B00011111 };
const int c2[] PROGMEM = { B00001110,
             B00010001,
             B00000100,
             B00000010,
             B00011111 };  
const int c3[] PROGMEM = { B00011111,
             B00010000,
             B00011110,
             B00010000,
             B00011111 };  
const int c4[] PROGMEM = { B00001100,
             B00010100,
             B00000100,
             B00000100,
             B00011111 };  
const int c5[] PROGMEM = { B00001100,
             B00010100,
             B00000100,
             B00000100,
             B00011111 };  
const int c6[] PROGMEM = { B00001100,
             B00010100,
             B00000100,
             B00000100,
             B00011111 };  
const int c7[] PROGMEM = { B00001100,
             B00010100,
             B00000100,
             B00000100,
             B00011111 };  
const int c8[] PROGMEM = { B00001100,
             B00010100,
             B00000100,
             B00000100,
             B00011111 };      
const int c9[] PROGMEM = { B00001100,
             B00010100,
             B00000100,
             B00000100,
             B00011111 };  
